<template>
  <div>
    <div class="position_absolute" style="bottom: 1rem; left: 1rem;">
      ...
      <div v-if="accountFacebookList.length > 0 && facebook.status === false">
        <div
        ...
        >
          ...
          <div class="toast--body">
            ...
            <b class="im">{{ facebook.userInfo.name }}</b> trên facebook. Vui
            lòng cập nhật lại mã kích hoạt tài khoản facebook tại đây!
          </div>
        </div>
      </div>
      <!-- Then put toasts within -->
      ...
      >
        ...
        <div class="toast--body">
          ...
          <span class="im">mất</span>, hoặc <span class="im">quá yếu</span>. Vui
          lòng kiểm tra lại đường truyền mạng để có được trải nghiệp tốt nhất
          trên hệ thống!
        </div>
      </div>
    </div>
